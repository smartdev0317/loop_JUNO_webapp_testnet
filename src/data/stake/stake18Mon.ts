...
export const getLockTimeFrameForUnstake18MonQuery = selector({
    ...
    get: async ({ get }) => {
        ...
        return await client.queryContractSmart(contracts['loop_farm_staking'] ?? '', { loop_staking_18: { }});
...
export const getLockTimeFrameForUnstake3MonQuery = selector({
    ...
    get: async ({ get }) => {
        ...
        return await client.queryContractSmart(contracts['loop_staking_3'] ?? '', { query_lock_time_frame: { }});
    },
})
