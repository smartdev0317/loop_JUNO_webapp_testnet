...
const FormGroupV2 = ({
  ...
  useEffect(()=>{
   input?.autoFocus && inputRef.current?.focus()
  },[input])
        ...
        >
                    ...
                    isGasFeeAvailable() ? (
                      <span className={styles.maxContainer}>
                        ...
                        <span
                          {...maxProps}
                          className={classNames(
                            styles.slippagePax_span,
                            styles.slippagePax_spanMax
                          )}
                        >
                          MAX
                        </span>
          ...
          >
            MAX
                      ...
                      <Tooltip content={'Leave a JUNO balance for gas fees'} className={styles.overrideTooltip} >
                        <span className={styles.maxContainer}>
                          <span
                            className={styles.slippagePax_span}
                          >
          ...
          >
            ...
            >
              ...
              { (input && input?.uusdBalance) && <span className={styles.uusdBalance}>~{commas(decimal(input.uusdBalance, 4))} {USDC}</span>}
            </section>
          </section>
          {assets && (
            <section
