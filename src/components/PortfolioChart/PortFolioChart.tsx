...
const PortFolioChart = () => {
  ...
  const poolData = pool?.dataSource?.filter((data) =>
  ...
  const dataSource =
    tab === 1
      ...
      : tab === 2
      ? parseDataSource(poolData, "pool", "withdrawableValue", "symbol")
      : tab === 3
      ? null
          ...
          <div className={styles.wrapper}>
            ...
            >
              {window.innerWidth > 768 ? (
                ...
                <>
                  {dataSource.data1?.length ? dataSource?.data1?.slice(0, 4)?.map((item, index) => {
                    return (
                      <span className={styles.holdingData}>
                        <span
                          style={{ color: colorArray[index] }}
