...
interface Props {
  ...
  className?: string
  lazy?: boolean
  changeTopMargin?: boolean
}

const Page: FC<Props> = ({className, title, description, children, changeTopMargin,...props }) => {
  ...
  return (
    <article className={changeTopMargin ? classNames(styles.newArticle,styles.pageSettings, className) :classNames(styles.article,styles.pageSettings, className) }>
      {title && (
