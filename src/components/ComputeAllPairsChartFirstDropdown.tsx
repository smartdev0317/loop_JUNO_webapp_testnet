...
const ComputeAllPairsChartFirstDropdown = ({ setTokens, lpProp,setLpToken }:{ setTokens:any, lpProp?: string, setLpToken?:any}) => {
...
export default ComputeAllPairsChartFirstDropdown