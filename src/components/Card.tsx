...
const Card: FC<Props> = (props) => {
  ...
  const attrs = {
    className: cx(webApp ? styles.webappCard : styles.card, { lg, full, link: to, shadow, padded }, className ,newDesign && styles.newDesign),
    children: (
      <>
        {hasForm ? (
          <FormCardHeader {...props} headerClass={headerClass}  headerBorder={headerBorder} showHeaderTabs={showHeaderTabs} />
          ) : (
           <CardHeader {...props} headerClass={headerClass} newDesign={newDesign} />
       )}
        {button_section}
        {badges && (
