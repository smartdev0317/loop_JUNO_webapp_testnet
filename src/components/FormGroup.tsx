      ...
      <div className={cx(type === 1 && border)}>
        ...
        >
          ...
          >
            ...
            >
              {help && (
                <b className={classNames(styles.pendiongSlippage, slippageClassName ? slippageClassName : "", miniForm ? styles.pendiongSlippageMini  : '', multiLines ? styles.slippageFormMultiMeta : '')}>{help.content}</b>
              )}
