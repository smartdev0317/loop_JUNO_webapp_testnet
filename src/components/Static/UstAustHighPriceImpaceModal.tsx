...
export const HighPriceImpactModal = ({toggleConfirmModal, submitForm}:{toggleConfirmModal: ()=> void, submitForm: () => void}) => {
  return (
    <Grid className={styles.container}>
      <div>
        <h6 className={styles.heading}>Loop Cares About You</h6>
        ...
        <Button className={styles.button} size={'md'} onClick={()=> { submitForm(); toggleConfirmModal()}}  >SWAP ANYWAY</Button>
        </Grid>
      </div>
    </Grid>
  )
