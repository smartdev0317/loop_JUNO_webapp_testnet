                ...
                version === 2 ? <>
                        <section className={styles.content}>
                            <HeaderModal title={"HOW TO POOL?"} content={
                                "By adding liquidity you’ll earn 0.2% of all trades on the pair + farm rewards"
                            } hidden={false} noMobile={false}/>
                            <div className={styles.childPool}>{children}</div>
                        </section>
                        <section className={styles.content}>
                            {bound(<RecommendedPools isFirstTokenBalanceZero={isFirstTokenBalanceZero}
                                                     setIsTokenSelected={setIsTokenSelected}
                                                     isTokenSelected={isTokenSelected} setPairlpToken={setPairlpToken}
                                                     setPairAddr={setPairAddr} setFirstToken={setFirstToken}
                                                     setSecondToken={setSecondToken} isValueZero={isValueZero}
                                isPercentageButtons={isPercentageButtons} type={type} />)}
                        </section>
                    </>
                    :
                    <>
