...
interface Props {
  ...
  /** Gov stake */
  gov?: boolean
  farmResponseFun?: (res: DeliverTxResponse | undefined) => void
  partial?: boolean
}
...
const StakeForm = ({
  ...
  const data = {
    [Type.STAKE]: [
      gov
        ? newContractMsg(contracts["loopToken"], {
            send: {
              amount,
  ...
  return (
    <FormContainer {...container} farmResponseFun={farmResponseFun}>
