...
import styles from "./WebAppSetManualSlippageTolerance.module.scss"

const cx = classNames.bind(styles)

const WebAppSlippageTolerance = ({ state, error }: Props) => {
  ...
  return (
    <div className={styles.card}>
      <section className={styles.list + " " + styles.slippageList}>
        ...
        >
          <span className={styles.title}>Slippage Tolerance</span>
...
const WebAppSetManualSlippageTolerance = (props: Props) => {
  return (
    <div className={styles.component}>
      <WebAppSlippageTolerance {...props} />
    </div>
  )
}

export default WebAppSetManualSlippageTolerance
