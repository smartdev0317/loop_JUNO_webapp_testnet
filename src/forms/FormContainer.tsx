...
import {SMALLEST, UJUNO, USDC} from "../constants"
...
import {ResetPageTitle} from "../layouts/App";
...
export const FormContainer = ({
  ...
  const uusd = multiple(findBalanceFn(UJUNO) ?? "0", SMALLEST)
  ...
  const invalid =
    address && (!gt(uusd, uusdAmount) && verifyUstBalance)
      ? ["Not enough JUNO to pay the transaction fee. Add some JUNO to your wallet and try again."]
      : undefined
